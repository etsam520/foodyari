    ...
    <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
            <a href="{{route('admin.dashboard')}}" class="navbar-brand">
                <h4 class="logo-title">FoodYari</h4>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a href="javascript:void(0)" class="nav-link position-relative" id="admin-notification-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" id="admin-nav-notification-badge" style="display: none; font-size: 10px;">
                                <span id="admin-nav-notification-count">0</span>
                                <span class="visually-hidden">unread notifications</span>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end p-0 shadow-lg border-0" style="width: 380px; max-height: 500px;">
                            <div class="card border-0">
                                <div class="card-header bg-primary text-white py-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold">
                                            <i class="tio-notifications me-2"></i>Admin Notifications
                                        </h6>
                                        <div class="d-flex align-items-center">
                                            <span class="badge bg-white text-primary me-2" id="admin-nav-total-count">0</span>
                                            <a href="{{ route('admin.notification.inbox') }}" class="text-white text-decoration-none">
                                                <small><i class="tio-inbox me-1"></i>View All</small>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body p-0" style="max-height: 350px; overflow-y: auto;">
                                    <div id="admin-nav-notification-list" class="notification-list">
                                ...
                                <div class="card-footer bg-light text-center py-2">
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <a href="{{ route('admin.notification.inbox') }}" class="btn btn-outline-primary btn-sm w-100">
                                                <i class="tio-inbox me-1"></i>Inbox
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li class="nav-item dropdown">
                        <a href="javascript:void(0)" class="search-toggle nav-link" id="dropdownMenuButton2">
                            <img src="{{asset('assets/images/Flag/ind-flg.png')}}" class="img-fluid rounded-circle"
                    ...
                    <li class="nav-item dropdown">
                        <a href="javascript:void(0)" class="nav-link" id="notification-drop" data-bs-toggle="dropdown">
                            ...
                            <span class="bg-danger dots admin-notification-badge" id="admin-notification-badge" style="display: none;"></span>
                        </a>
                        <div class="p-0 sub-drop dropdown-menu dropdown-menu-end" aria-labelledby="notification-drop" style="width: 350px;">
                            <div class="m-0 shadow-none card">
                                ...
                                <div class="p-0 card-body" id="admin-notification-preview" style="max-height: 300px; overflow-y: auto;">
                                ...
                                <div class="card-footer bg-light text-center">
                                    <a href="{{ route('admin.notification.inbox') }}" class="btn btn-primary btn-sm">
                    ...
                    <li class="nav-item dropdown">
                        <a href="javascript:void(0)" class="nav-link" id="mail-drop" data-bs-toggle="dropdown"
                    ...
                    <li class="nav-item dropdown">
                        <a class="py-0 nav-link d-flex align-items-center" href="javascript:void(0)" id="navbarDropdown"
                            ...
                            <div class="caption ms-3 d-none d-md-block ">
                                ...
                                @endphp
                                <h6 class="mb-0 caption-title">{{Str::ucfirst($admin->f_name).' '.Str::ucfirst($admin->l_name)}}</h6>
                                {{-- <p class="mb-0 caption-sub-title">Role</p> --}}
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{route('admin.profile.views')}}">Profile</a></li>

                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{route('admin.auth.logout')}}">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        <div class="logo-main">
                            <div class="logo-normal">
                                <img src="{{asset('assets/images/icons/foodyari.logo.jpg')}}" alt="logo" style="width: 100px;border-radius: 50%;">
                            </div>
                            <div class="logo-mini">
                                <img src="{{asset('assets/images/icons/foodyari.logo.jpg')}}" alt="logo" style="width: 100px;border-radius: 50%;">
