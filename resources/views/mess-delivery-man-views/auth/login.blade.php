...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Food Yari| Mess Delivery Man </title>
                  ...
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           ...
                           <br>
                           <br>
                           <h2 class="mb-2 text-center">Mess Delivery Man|Panel|Login</h2>
                           <p class="text-center">Login to stay connected.</p>
                           <br><br>
                           {{-- <p class="text-center"><a href="javascript:void(0)">Restaurent Login Click Here</a></p> --}}
                           
                           <form action="{{route('mess-deliveryBoy.auth.login')}}" method="POST">
                            @csrf
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       <label for="email" class="form-label">Email</label>
                                       <input type="email" name="email" class="form-control" value="{{old('email')}}" id="email" aria-describedby="email" placeholder=" ">
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
                              ...
                              <div class="d-flex justify-content-center">
                                 <ul class="list-group list-group-horizontal list-group-flush">
                                    <li class="list-group-item border-0 pb-0">
                                       <a href="javascript:void(0)"><img src="{{asset('assets/images/brands/fb.svg')}}" alt="fb"></a>
                                    </li>
                                    <li class="list-group-item border-0 pb-0">
                                       <a href="javascript:void(0)"><img src="{{asset('assets/images/brands/gm.svg')}}" alt="gm"></a>
                                    </li>
                                    <li class="list-group-item border-0 pb-0">
                                       <a href="javascript:void(0)"><img src="{{asset('assets/images/brands/im.svg')}}" alt="im"></a>
                                    </li>
                                    <li class="list-group-item border-0 pb-0">
                                       <a href="javascript:void(0)"><img src="{{asset('assets/images/brands/li.svg')}}" alt="li"></a>
                                    </li>
                                 </ul>
                              </div>
