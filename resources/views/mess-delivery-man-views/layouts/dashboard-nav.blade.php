                ...
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="py-0 nav-link d-flex align-items-center" href="javascript:void(0)" id="navbarDropdown"
                            ...
                            <div class="caption ms-3 d-none d-md-block ">
                                <h6 class="mb-0 caption-title">
                                    @php($user_details = Session::get('mess_deliveryman'))
                                    
                                    {{ Str::upper($user_details->f_name . ' ' . $user_details->l_name) }}
                                </h6>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{route('mess-deliveryBoy.auth.logout')}}">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
