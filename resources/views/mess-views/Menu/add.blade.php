       ...
       <div class="row">
          <div class="col-xl-4 col-lg-4">
             <div class="card">
                ...
                <div class="card-body">
                   <form action="{{route('mess.menu.add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                      <div class="form-group">
                        <div class="card-body ">
                           <img class="initial-57-2" id="item-image"
                               src="http://localhost/foodyari-new/public/assets/images/icons/restaurant-default-image.png"
                      ...
                      </div>@php($services = App\CentralLogics\Helpers::getService())
                      {{-- @dd($services) --}}
                      <div class="form-group">
                         ...
                         <select name="setTo"  class="selectpicker form-control" data-style="py-0">
                            ...
                            @if ($services)
                                @foreach ($services as $key => $value)
                                    <option value="{{ $key }}" class="text-uppercase">{{ $value }}</option>
                                @endforeach
                            @endif
                         </select>
                      </div>
