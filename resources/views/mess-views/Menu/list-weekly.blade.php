                            ...
                            <div class="table-responsive">
                                <table id="user-list-table" class="table" role="grid" data-toggle="data-table">
                                   ...
                                   <tbody>
                                        ...
                                        <tr>
                                            <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{$menu->image?asset("MessMenu/$menu->image"):asset('assets/images/icons/food.svg')}}" alt="profile"></td>
                                            <td>{{Str::upper($menu->day) }}</td>
                                            <td>{{$menu->name}}</td>
                                            ...
                                            <div class="flex align-items-center list-user-action">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-warning"  href="{{route('mess.menu.edit.weekly',['id'=> $menu->id])}}">
