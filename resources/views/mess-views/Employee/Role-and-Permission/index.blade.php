                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @endif
                                        <form action="{{route('mess.roles.add')}}" method="POST">
                                            @csrf
                                            <div class="form-group">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">ADMIN
                                        ...
                                        <a class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="Edit User" href="javascript:void(0)">
                                        ...
                                        <a class="btn btn-sm btn-icon text-danger"  data-bs-toggle="tooltip" title="Delete User" href="javascript:void(0)">
                                            <span class="btn-inner">
