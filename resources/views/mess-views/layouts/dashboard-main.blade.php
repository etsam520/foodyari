...
<head>
    ...
    <title>Food Yari| Mess Dashboard </title>
...
<body class="  ">
    ...
    @include('mess-views.layouts.dashboard-aside')
    <main class="main-content">
        @include('mess-views.layouts.dashboard-nav')
        
        @yield('content')

        <!-- Footer Section Start -->
        @include('mess-views.layouts.dashboard-footer')
        <!-- Footer Section End -->
    </main>
