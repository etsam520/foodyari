                    ...
                    <li class="nav-item dropdown">
                        <a class="py-0 nav-link d-flex align-items-center" href="javascript:void(0)" id="navbarDropdown"
                            ...
                            <div class="caption ms-3 d-none d-md-block ">
                                <h6 class="mb-0 caption-title">@php($mess_details = Session::get('mess')) {{$mess_details['name']}}</h6>
                                <p class="mb-0 caption-sub-title">Role</p>
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{route('mess.profile.update')}}">Profile</a></li>
                            <li><a class="dropdown-item" href="dashboard/app/user-privacy-setting.html">Privacy
                                    Setting</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{route('mess.auth.logout')}}">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
