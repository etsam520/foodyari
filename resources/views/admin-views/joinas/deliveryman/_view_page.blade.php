                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-12">
                                    <div class="card-body p-4">
                                        <!-- Contact Information -->
                                        <h3>Deliveryman Joinee Form Information</h3>
                                        <hr class="mt-0 mb-4">
                                        <div class="row pt-1">
                                            <div class="col-md-6 mb-2">
                                                <h6>Delivleryman Name</h6>
                                                <p class="text-muted">
                                                    {{Str::ucfirst($joinAsDeliveryman['deliveryman_name'])}}
                                                </p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Phone No.</h6>
                                                <p class="text-muted">{{$joinAsDeliveryman['deliveryman_phone']}}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Email ID</h6>
                                                <p class="text-muted">{{$joinAsDeliveryman['deliveryman_email']}}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Full Address</h6>
                                                <p class="text-muted">{{$joinAsDeliveryman['deliveryman_address']}}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Bike Number</h6>
                                                <p class="text-muted">{{$joinAsDeliveryman['bike_number']}}</p>
                                            </div>
                                            <div class="col-12">
                                                <hr class="hr-horizontal">
                                            </div>
                                            <div class="col-md-12 mb-2 mt-3">
                                                <h6>KYC Status ({{Str::ucfirst($joinAsDeliveryman->kyc->status)}})</h6>
                                                @if($joinAsDeliveryman->kyc->status == "pending")
                                                <p class="text-muted mt-2">
                                                    <span class="d-flex">
                                                        <button class="btn btn-sm btn-primary me-2" onclick="updateKycStatus(this)" url="{{route('admin.joinas.deliveryman-kyc-update-status', ['id' => $joinAsDeliveryman->kyc->id, 'status' => 'rejected'])}}">Reject</button>
                                                        <button class="btn btn-sm btn-success" onclick="updateKycStatus(this)" url="{{route('admin.joinas.deliveryman-kyc-update-status', ['id' => $joinAsDeliveryman->kyc->id, 'status' => 'approved'])}}">Approve</button>
                                                    </span>
                                                </p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2 mt-3">
                                                <h6>Form Status ({{Str::ucfirst($joinAsDeliveryman->status)}})</h6>
                                                 @if($joinAsDeliveryman->status == "pending")
                                                <p class="text-muted mt-2">
                                                    <span class="d-flex">
                                                        <button class="btn btn-sm btn-primary me-2" onclick="updateFormStatus(this)" url="{{route('admin.joinas.deliveryman-form-update-status',['id'=> $joinAsDeliveryman->id , 'status' => 'rejected'])}}">Reject</button>
                                                        <button class="btn btn-sm btn-success"  onclick="updateFormStatus(this)" url="{{route('admin.joinas.deliveryman-form-update-status',['id'=> $joinAsDeliveryman->id , 'status' => 'approved'])}}">Approve</button>
                                                    </span>
                                                </p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2 mt-3">
                                                <p class="text-muted mt-2">
                                                    @if($joinAsDeliveryman->deliveryman_id == null)
                                                    <span class="d-flex">
                                                        <a href="{{route('admin.joinas.deliveryman-create', ['id'=> $joinAsDeliveryman->id])}}" class="btn btn-sm btn-success" >Create Deliveryman</a>
                                                    </span>
                                                    @else
