                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-12">
                                    <div class="card-body p-4">
                                        <!-- Contact Information -->
                                        <h3>Restaurant Joinee Form Information</h3>
                                        <hr class="mt-0 mb-4">
                                        <div class="row pt-1">
                                            <div class="col-md-6 mb-2">
                                                <h6>Restaurant Name</h6>
                                                <p class="text-muted">
                                                    {{Str::ucfirst($joinAsRestaurant['restaurant_name'])}}
                                                </p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Phone No.</h6>
                                                <p class="text-muted">{{$joinAsRestaurant['restaurant_phone']}}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Email ID</h6>
                                                <p class="text-muted">{{$joinAsRestaurant['restaurant_email']}}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Full Address</h6>
                                                <p class="text-muted">{{$joinAsRestaurant['restaurant_address']}}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <h6>Owner Name</h6>
                                                <p class="text-muted">{{$joinAsRestaurant['restaurant_owner_name']}}</p>
                                            </div>
                                            <div class="col-12">
                                                <hr class="hr-horizontal">
                                            </div>
                                            <div class="col-md-12 mb-2 mt-3">
                                                <h6>KYC Status ({{Str::ucfirst($joinAsRestaurant->kyc->status)}})</h6>
                                                @if($joinAsRestaurant->kyc->status == "pending")
                                                <p class="text-muted mt-2">
                                                    <span class="d-flex">
                                                        <button class="btn btn-sm btn-primary me-2" onclick="updateKycStatus(this)" url="{{route('admin.joinas.restaurant-kyc-update-status', ['id' => $joinAsRestaurant->kyc->id, 'status' => 'rejected'])}}">Reject</button>
                                                        <button class="btn btn-sm btn-success" onclick="updateKycStatus(this)" url="{{route('admin.joinas.restaurant-kyc-update-status', ['id' => $joinAsRestaurant->kyc->id, 'status' => 'approved'])}}">Approve</button>
                                                    </span>
                                                </p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2 mt-3">
                                                <h6>Form Status ({{Str::ucfirst($joinAsRestaurant->status)}})</h6>
                                                 @if($joinAsRestaurant->status == "pending")
                                                <p class="text-muted mt-2">
                                                    <span class="d-flex">
                                                        <button class="btn btn-sm btn-primary me-2" onclick="updateFormStatus(this)" url="{{route('admin.joinas.restaurant-form-update-status',['id'=> $joinAsRestaurant->id , 'status' => 'rejected'])}}">Reject</button>
                                                        <button class="btn btn-sm btn-success"  onclick="updateFormStatus(this)" url="{{route('admin.joinas.restaurant-form-update-status',['id'=> $joinAsRestaurant->id , 'status' => 'approved'])}}">Approve</button>
                                                    </span>
                                                </p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-2 mt-3">
                                                <p class="text-muted mt-2">
                                                    @if($joinAsRestaurant->restaurant_id == null)
                                                    <span class="d-flex">
                                                        <a href="{{route('admin.joinas.restaurant-create', ['id'=> $joinAsRestaurant->id])}}" class="btn btn-sm btn-success" >Create Restaurant</a>
                                                    </span>
                                                    @else
                                                    Defalt Password : password1234
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex flex-wrap">
                                                ...
                                                <button class="btn btn-sm btn-primary" onclick="updateDocumentStatus(this)" url="{{route('admin.joinas.restaurant-doc-update-status',['id'=>$documentDetail->id, 'status'=>'rejected'])}}">Reject</button>
                                                @endif
                                                @if($documentDetail->status == "rejected" || $documentDetail->status == "pending")
                                                <button class="btn btn-sm btn-success" onclick="updateDocumentStatus(this)" url="{{route('admin.joinas.restaurant-doc-update-status',['id'=>$documentDetail->id, 'status'=>'approved'])}}">Approve</button>
                                                @endif
