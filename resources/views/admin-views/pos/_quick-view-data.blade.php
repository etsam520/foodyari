...
.wrapper .btn {
  background: #fd6561;
  box-shadow: 0px 10px 20px -5px rgba(253, 101, 97, 0.4);
  padding: 18px 50px;
  font-size: 18px;
  line-height: 22px;
  text-align: center;
...
.wrapper .content .right .rightContent .specs .size .dropdown .dropOpen:before, .wrapper .content .right .rightContent .specs .size .dropdown .dropOpen:after {
  content: "";
  position: absolute;
  width: 100%;
  height: 0;
...
.wrapper .content .right .rightContent .specs .size .dropdown.open .dropOpen:before, .wrapper .content .right .rightContent .specs .size .dropdown.open .dropOpen:after {
  transition: all 0.4s ease;
  height: 100%;
}
...
.galleryMain .swiper-slide.swiper-slide-next, .galleryMain .swiper-slide.swiper-slide-prev {
  opacity: 0.5;
}
@media screen and (max-width: 799px) {
  .galleryMain .swiper-slide.swiper-slide-next, .galleryMain .swiper-slide.swiper-slide-prev {
                    ...
                    <div class="rightContent">
                        ...
                        <div class="btnContainer">
                            <button class="btn add">
                                <img src="https://rafaelalucas.com/dailyui/12/assets/shopping-cart-w.svg"
                                    alt="">
                                add to cart</button>
                        </div>
