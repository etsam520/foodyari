    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="javascript:void(0)" method="post" enctype="multipart/form-data" id="vehicle-form">
                        @csrf
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="Vehicle_type" class="form-control" value="{{$vehicle->type}}" placeholder="Enter Vehicle Type" required name="type">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="input-label text-uppercase" for="extra_charges">extra charges (₹) </label>
                                            <input type="number" id="extra_charges" class="form-control" placeholder="Enter Extra Charges" step="0.001" min="0" value="{{$vehicle->extra_charges}}" required name="extra_charges">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="starting_coverage_area" class="form-control" value="{{$vehicle->starting_coverage_area}}" placeholder="Enter Minimum Coverage Area" step="0.001" min="0" required name="starting_coverage_area">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="input-label text-uppercase" for="maximum_coverage_area">maximum coverage area (KM) </label>
                                            <input type="number" id="maximum_coverage_area" class="form-control" value="{{$vehicle->maximum_coverage_area}}" placeholder="Enter Maximum Coverage Area" step="0.001" min="0"  required name="maximum_coverage_area">
                                        </div>
                                    </div>
...
<script>
    ...
    vehicleForm.addEventListener('submit', async (event) => {
        ...
        try {
            const res = await fetch("{{route('admin.vehicle.update',$vehicle->id)}}", {
                method: 'POST',
