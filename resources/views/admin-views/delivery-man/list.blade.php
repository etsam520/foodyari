                      ...
                      <table id="datatable" class="table" role="grid" data-toggle="data-table">
                         <thead>
                            <tr>
                                ...
                                <th class="text-capitalize text-center">{{ __('KYC') }}</th>
                         ...
                         <tbody>
                            @foreach($delivery_men->toArray() as $key=>$dm)
                                <tr>
                                    <td>{{$loop->index + 1}}</td>
                                    <td>
                                        <a class="table-rest-info d-flex justify-content-evenly "
                                        href="{{route('admin.delivery-man.show',['id' => $dm['id']])}}"
                                        >
                                            <img onerror="this.src='{{asset('assets/user/img/user2.png')}}'" class="rounded img-50"
                                                    src="{{asset("delivery-man/{$dm['image']}")}}" alt="{{$dm['f_name']}} ">
                                            <div class="info">
                                                ...
                                                <span class="d-block text-body">
                                                    ...
                                                    <span class="rating">
                                                        ...
                                                        {{Helpers::getRating($dm['id'],'deliveryman');}}
                                                    </span>
                                                    <!-- Rating -->
                                                </span>
                                            </div>
                                    ...
                                    <td class="text-center">
                                        <div class="pr-3">
                                            {{-- {{ $dm['orders'] ?? count($dm['orders']) }} --}}
                                        </div>
                                    </td>
                                    <td>
                                        <a href="{{route('admin.delivery-man.kyc',['dm_id' => $dm['id']])}}">View</a>
                                    </td>
                                    <td>
                                        <div>
                                            <!-- Status -->
                                            {{ __('Currenty Assigned Orders') }} : {{$dm['live_orders']}}
                                            <!-- Status -->
                                        </div>
                                        @if($dm['application_status'] == 'approved')
                                        {{-- @dd($dm) --}}
                                            @if($dm['attendances'] != null && $dm['attendances'][0]['is_online'])
                                            <div>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                href="{{ route('admin.delivery-man.history', ['id' => $dm['id']]) }}"
                                            ...
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn" href="{{route('admin.delivery-man.edit',[$dm['id']])}}" title="{{__('messages.edit')}} ">
                                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11.4925 2.78906H7.75349C4.67849 2.78906 2.75049 4.96606 2.75049 8.04806V16.3621C2.75049 19.4441 4.66949 21.6211 7.75349 21.6211H16.5775C19.6625 21.6211 21.5815 19.4441 21.5815 16.3621V12.3341" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.82812 10.921L16.3011 3.44799C17.2321 2.51799 18.7411 2.51799 19.6721 3.44799L20.8891 4.66499C21.8201 5.59599 21.8201 7.10599 20.8891 8.03599L13.3801 15.545C12.9731 15.952 12.4211 16.181 11.8451 16.181H8.09912L8.19312 12.401C8.20712 11.845 8.43412 11.315 8.82812 10.921Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path d="M15.1655 4.60254L19.7315 9.16854" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
