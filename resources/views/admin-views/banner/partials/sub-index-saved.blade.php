...
<div class="form-group">
    ...
    <select name="{{$name}}" id="{{$name.'_choose'}}" class="form-control select-2">
        ...
        <option value="{{$restaurant->id}}" {{$savedItem->restaurant_id == $restaurant->id ? 'selected' : null}}>{{Str::ucfirst($restaurant->name)}}</option>
        @endforeach
    </select>
</div>
<div class="form-group">
    ...
    <select name="screen_to" id="screen_to" class="form-control select-2">
        ...
        <option value="inside_restaurant" {{$savedItem->screen_to == "inside_restaurant" ? 'selected' : null}}>Inside Restaurant</option>
        <option value="outside_restaurant" {{$savedItem->screen_to == "outside_restaurant" ? 'selected' : null}}>Outside Restaurant</option>
    </select>
</div>
@elseif ($name == 'food')
<div class="form-group">
    ...
    <select name="{{$name}}" id="{{$name.'_choose'}}" class="form-control select-2">
        ...
        <option value="{{$food->id}}" {{$savedItem->food_id == $food->id ? 'selected' : null}}>{{Str::ucfirst($food->name)}} ({{Str::ucfirst($food->restaurant->name)}})</option>
        @endforeach
    </select>
</div>
...
<div class="form-group">
    ...
    <input name="link" id="link" value="{{$savedItem->link}}"  class="form-control" />
</div>
