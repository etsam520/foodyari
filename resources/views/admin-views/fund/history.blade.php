                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="dropdown me-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton22" style="">
                                   <li><a class="dropdown-item" href="{!! route('admin.fund.histories').'?filter=this_week' !!}">This Week</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.fund.histories').'?filter=this_month' !!}">This Month</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.fund.histories').'?filter=this_year' !!}">This Year</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.fund.histories').'?filter=previous_year' !!}">Previous Year</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.fund.histories').'?filter=today' !!}">Today</a></li>
                                </ul>
                            </div>
                            <form action="{{route('admin.fund.histories')}}">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">My Transaction Information</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="datatable-export" data-toggle="data-table-export">
                            <thead>
                                <tr>
                                    <th>##</th>
                                    <th>Amount</th>
                            ...
                            <tbody>
                                @foreach ($fundTxns as $history)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{Str::ucfirst($history->txn_type) }}</td>
