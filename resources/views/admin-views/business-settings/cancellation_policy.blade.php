            ...
            <div class="card">
                <div class="card-header ">
                    <div class="header-title d-flex justify-content-between">
                        <h4 class="card-title">{{__('messages.cancellation_policy')}}</h4>
                ...
                <div class="card-body px-0">
                    <form action="{{route('admin.business-settings.cancellation-policy')}}" method="post" id="tnc-form">
                        ...
                        <div class="form-group">
                            <textarea class="summernote form-control" id="summernote" name="cancellation_policy">{!! $data['data']??null!!}</textarea>
                        </div>
