                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="dropdown me-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton22" style="">
                                   <li><a class="dropdown-item" href="{!! route('admin.report.product').'?filter=this_week' !!}">This Week</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.report.product').'?filter=this_month' !!}">This Month</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.report.product').'?filter=this_year' !!}">This Year</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.report.product').'?filter=previous_year' !!}">Previous Year</a></li>
                                   <li><a class="dropdown-item" href="{!! route('admin.report.product').'?filter=today' !!}">Today</a></li>
                                </ul>
                            </div>
                            <form action="{{route('admin.report.product')}}">
                            ...
                            <tbody>
                                ...
                                {{-- @dd($product) --}}
                                    <tr>
                                        ...
                                        <td>{{Str::ucfirst($product['restaurant_name'])}}</td>
