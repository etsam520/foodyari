...
<div class="bg-white container-fluid fixed-bottom">
    <div class="row">
        <div class="col-3 text-center" onclick="location.href='{{route('deliveryman.mess.order-list',['state'=>'newly'])}}'" type="button">
        ...
        <div class="col-3 text-center" onclick="location.href='{{route('deliveryman.mess.order-list',['state'=>'accepted'])}}'" type="button">
        ...
        <div class="col-3 text-center" onclick="location.href='{{route('deliveryman.mess.order-list',['state'=>'pickedUp'])}}'" type="button">
