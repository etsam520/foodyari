...
<body class="fixed-bottom-bar">
    ...
    @include('deliveryman.mess.layouts.header')
    @include('deliveryman.mess.partials.notifications')
    ...
    @include('deliveryman.mess.layouts.footer')

    @include('deliveryman.mess.layouts.nav')
