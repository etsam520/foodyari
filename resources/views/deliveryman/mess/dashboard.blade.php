@extends('deliveryman.mess.layouts.main')
@section('content')

@include('deliveryman.mess.layouts.m-header')
<div class="osahan-home-page">

    <!-- Moblile header end -->
    <div class="main">
        <div class="container">
            @include('deliveryman.mess.layouts.activate')
        </div>
            ...
            <div class="row justify-content-center pt-3">
                <div class="col-12 col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-6  mb-3">
                            <div class="bg-white shadow-sm rounded p-4 text-center">
                                <p class="mb-3 text-primary order-count text-center">{{App\Models\MessDeliverymanOrderAccept::select('id','dm_id')->where('dm_id', auth('delivery_men')->user()->id)->count()
                                }}</p>
...
async function loadOrders(params) {
    try {
        const resp = await fetch('{{route('deliveryman.mess.orders')}}');
...
loadOrders();
async function messOrderAcceptOrReject() {
