                  ...
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           ...
                           <br>
                           <br>
                           <h2 class="mb-2 text-center">User|Panel|Login</h2>
    ...
    <script>
     ...
     try {
         navigator.geolocation.getCurrentPosition(async (position) => {
             ...
             const resp = await fetch('{{route('user.auth.locationSet') }}?location=' + currentLocation); 
             const result = await resp.json();
             if (!resp.ok || result.error) {
                 toastr.error('Please Grant Permission of Location');
             }
         });
     } catch (error) {
