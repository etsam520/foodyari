                ...
                <div class="col-3 d-flex align-items-center m-none">
                    <div class=" me-3">
                        <a class="text-dark d d-flex align-items-center py-3" role="button" role="button" data-bs-toggle="offcanvas" data-bs-target="@if (isset($userLocations[0])) #userSavedLocation @else #userNewLocation @endif">
                            ...
                            <div class="location-bar text-truncate ms-1 small" >{{ $default_address['address'] }}
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end pe-5">
                        ...
                        <div class="dropdown me-4 m-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{"https://wa.me/".Helpers::get_business_settings('phone')."?text=Hello%2C%20I%20need%20help%20regarding%20my%20recent%20order."}}"><i class="fas fa-comments h6 me-2 mb-0"></i>Chat Support</a>
