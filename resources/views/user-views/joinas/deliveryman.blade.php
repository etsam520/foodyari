...
@push('css')
<style>
    .deliveryman-registration-container {
        background: #f8dcb4;
...
@section('containt')
    <div class="deliveryman-registration-container">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10 px-0">
                    <div class="registration-card">
                        <div class="registration-header d-flex">
                            <h2><i class="fas fa-motorcycle me-2 mt-1"></i></h2>
                            <div>
                                <h2 class="mb-0">Join us as Delivery Boy</h2>
                                <small class="text-white">Partner with us and start earning on flexible hours</p>
                            </div>
                        </div>
                        ...
                        <div class="registration-form">
                            ...
                            <form action="{{ route('join-as.deliveryman-save') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <!-- Delivery Boy Basic Information -->
                                <div class="form-section">
                                    <h3 class="section-title"><i class="fas fa-user me-2"></i>Personal Information</h3>
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">Delivery Boy Full Name<span class="required-asterisk">*</span>
                                                    <small class="d-block text-muted">(As per mentioned in ID Proof)</small>
                                                </label>
                                                <input type="text" class="form-control" name="dm_name"
                                                       value="{{old('dm_name')}}" placeholder="Enter full name">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">Bike Number<span class="required-asterisk">*</span></label>
                                                <input type="text" class="form-control" name="bike_no"
                                                       value="{{old('bike_no')}}" placeholder="Enter bike number">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="form-label">Full Address<span class="required-asterisk">*</span></label>
                                                <input type="text" class="form-control" name="dm_address" required
                                                       value="{{old('dm_address')}}" placeholder="Enter complete address">
                                            </div>
                                        </div>
                                    </div>
                                </div>
