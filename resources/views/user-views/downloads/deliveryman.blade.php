            ...
            <div class="py-5 osahan-profile row d-flex justify-content-center" style="backdrop-filter: blur(6px);">
                ...
                <div class="col-md-4 mb-3">
                    <div class="rounded-5 shadow-sm p-5 text-center bg-white" style="border-top: 16px solid #ff810a;">
                        <h4 class="mb-4 pb-3 fw-bolder">Deliveryman App</h4>
                        <button onclick="deliverymanRedirectToStore()" class="btn btn-primary"><i class="fas fa-download me-2"></i>Download</button>
                    </div>
                </div>
...
<script>
    ...
    function deliverymanRedirectToStore() {
