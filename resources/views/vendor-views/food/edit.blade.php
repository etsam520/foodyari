                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">{{ __('Edit Food') }}</h4>
                            </div>
                        </div>
                        <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                          ...
                          <form class="row g-3 needs-validation" method="POST" enctype="multipart/form-data"  action="{{route('vendor.food.update')}}">
                            @csrf
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-2">
                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="input-label"
                                                        for="menu-input">Menu<span
                                                            ...
                                                            <?php
                                                                $menu = App\Models\RestaurantMenu::where('restaurant_id', Session::get('restaurant')->id)->get();
                                                            ?>
                                                    <select name="restaurant_menu_id" id="menu-input" onchange="get_options('{{route('vendor.food.get-submenu-option').'?menu_id='}}'+this.value , '#sub-menu-input')"
                                            ...
                                            @php( $addons = App\Models\Addon::where('restaurant_id',Session::get('restaurant')->id)->get())
                                            <div class="col-sm-6 col-lg-4">
                                                <div class="form-group mb-0">
                                                    <label class="input-label"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="time" name="available_time_ends" class="form-control"
                                                    id="available_time_ends" placeholder="5:45 pm" value="{{$food['available_time_ends']}}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
