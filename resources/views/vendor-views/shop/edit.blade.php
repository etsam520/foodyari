                            ...
                            <div class="row gy-3 gx-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{$shop->name}}" placeholder="{{ translate('Restaurant Name') }}" class="form-control h--45px" id="name"
                                                required>
                                    </div>
                                    <div class="form-group mb-0 pt-lg-1">
                                        ...
                                        <input type="tel" name="contact" value="{{$shop->phone}}" placeholder="{{ translate('Enter Phone Number') }}" class="form-control h--45px" id="contact"
                                                required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea type="text" rows="4" name="address" value="" placeholder="{{ translate('Enter Address') }}" class="form-control min-height-149px" id="address" required>{{$shop->address}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
