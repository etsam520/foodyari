                ...
                <div class="col-lg-12">
                    <ul class="nav nav-tabs mb-4 border-0">
                        @foreach(json_decode($language) as $lang)
                            <li class="nav-item">
                                <a class="nav-link lang_link {{$lang == $default_lang? 'active':''}}" href="javascript:void(0)" id="{{$lang}}-link">{{\App\CentralLogics\Helpers::get_language_name($lang).'('.strtoupper($lang).')'}}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                            ...
                            @foreach(json_decode($language) as $lang)
                                <div class="{{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" {{$lang == $default_lang? 'required':''}} name="name[]" id="{{$lang}}_name" class="form-control h--45px" placeholder="{{translate('New Food')}}" oninvalid="document.getElementById('en-link').click()">
                                    </div>
                                    ...
                                    <div class="form-group pt-4 mb-0">
                                        ...
                                        <textarea type="text" name="description[]" class="form-control ckeditor min-height-154px" placeholder="{{ translate('Description') }}"></textarea>
                                    </div>
                                </div>
                            @endforeach
                        @else
...
<script>
   ...
   function show_min_max(data){
    ...
    //         </div>
    //         <div class="col-4">
    //             <label for="">{{  translate('price type')}}</label>
    //             <select class="form-control" name="options[`+count+`][values][`+countRow+`][optionPriceType]">
    //                 <option>fixed</option>
    ...
    //     var select = ["dropdown","checkbox","custom checkbox","radio button","custom radio button","multiple select","multi", "single"];
