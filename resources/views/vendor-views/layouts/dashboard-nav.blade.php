<div class="position-relative iq-banner">
    ...
    <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
            ...
            <style>
                .form-control:focus {
                    border: 1px solid #bfbfbfba !important;
            }
            </style>
            <div class="input-group search-input">
                <span class="input-group-text py-2 px-3" id="search-input" style="border: 1px solid #bfbfbfba;">
                ...
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <div class="m-0 border-0 shadow-none card">
                                <div class="p-0 ">
                                    <ul class="p-0 list-group list-group-flush">
                                        <li class="iq-sub-card list-group-item"><a class="p-0" href="javascript:void(0)"><img
                                                    src="{{asset('assets/images/Flag/flag-03.png')}}" alt="img-flaf"
                                                    class="img-fluid me-2"
                                                    style="width: 15px;height: 15px;min-width: 15px;" />Spanish</a>
                                        </li>
                                        <li class="iq-sub-card list-group-item"><a class="p-0" href="javascript:void(0)"><img
                                                    src="{{asset('assets/images/Flag/flag-04.png')}}" alt="img-flaf"
                                                    class="img-fluid me-2"
                                                    style="width: 15px;height: 15px;min-width: 15px;" />Italian</a>
                                        </li>
                                        <li class="iq-sub-card list-group-item"><a class="p-0" href="javascript:void(0)"><img
                                                    src="{{asset('assets/images/Flag/flag-02.png')}}" alt="img-flaf"
                                                    class="img-fluid me-2"
                                                    style="width: 15px;height: 15px;min-width: 15px;" />French</a>
                                        </li>
                                        <li class="iq-sub-card list-group-item"><a class="p-0" href="javascript:void(0)"><img
                                                    src="{{asset('assets/images/Flag/flag-05.png')}}" alt="img-flaf"
                                                    class="img-fluid me-2"
                                                    style="width: 15px;height: 15px;min-width: 15px;" />German</a>
                                        </li>
                                        <li class="iq-sub-card list-group-item"><a class="p-0" href="javascript:void(0)"><img
                                                    src="{{asset('assets/images/Flag/flag-06.png')}}" alt="img-flaf"
                                                    class="img-fluid me-2"
                    ...
                    <li class="nav-item dropdown">
                        <a class="py-0 nav-link d-flex align-items-center" href="javascript:void(0)" id="navbarDropdown"
                            ...
                            <div class="caption ms-3 d-none d-md-block me-3">
                                <h6 class="mb-0 caption-title">Admin Name</h6>
                                <p class="mb-0 caption-sub-title text-end">Role</p>
                            </div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{route('vendor.profile.update')}}">Profile</a></li>
                            {{-- <li><a class="dropdown-item" href="dashboard/app/user-privacy-setting.html">Privacy
                                    Setting</a></li> --}}
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="{{route('vendor.auth.logout')}}">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
