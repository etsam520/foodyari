...
<head>
    ...
    <title>Food Yari| Restaurant Dashboard </title>
    ...
    <!-- feather icon Css -->
    <link rel="stylesheet" href="{{asset('assets/vendor/icons/feather.css')}}">

    {{-- <link rel="stylesheet" href="{{asset('assets/user/vendor/bootstrap/css/bootstrap-utilities.min.css')}}"> --}}
...
<body class="  ">
    ...
    @include('vendor-views.layouts.dashboard-aside')
    <main class="main-content">
        @include('vendor-views.layouts.dashboard-nav')

        @yield('content')

        <!-- Footer Section Start -->
        @include('vendor-views.layouts.dashboard-footer')
        <!-- Footer Section End -->
    </main>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/settings/dark/04.png') }}" alt="hover" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover"
                                data-extra-value="sidebar-mini">
                            <img src="{{ asset('assets/images/settings/light/04.png') }}" alt="hover" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover"
                                data-extra-value="sidebar-mini">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/settings/dark/10.png') }}" alt="color" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type"
                                data-value="navs-bg-color">
                            <img src="{{ asset('assets/images/settings/light/11.png') }}" alt="color" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type"
                                data-value="navs-bg-color">
                        ...
                        <div class="text-center">
                            ...
                            <img src="{{ asset('assets/images/settings/light/13.png') }}" alt="transparent" class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
    ...
    <script>
        ...
        navigator.serviceWorker.addEventListener('message', function(event) {
            ...
            let title = event.data.notificationData.notification.title || event.data.notificationData.data.message || '';
    ...
    <script>
        function confirmOrder(orderId,title) {
            ...
            if (result.isConfirmed) {
                // Redirect to the accept order URL
                route += `&order_status=${'confirmed'}`;
                ...
                if (cancelResult.isConfirmed) {
                    ...
                    route += `&order_status=${'canceled'}`;
                    location.href = route + '&cancel_reason=' + reason;
                    // window.location.href = `/order-cancel-url?reason=${encodeURIComponent(reason)}`;
                }
                });
            }
            });
