                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="dropdown me-3">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton22" style="">
                                   <li><a class="dropdown-item" href="{!! route('vendor.order.list', $statusKey).'?filter=this_week' !!}">This Week</a></li>
                                   <li><a class="dropdown-item" href="{!! route('vendor.order.list', $statusKey).'?filter=this_month' !!}">This Month</a></li>
                                   <li><a class="dropdown-item" href="{!! route('vendor.order.list', $statusKey).'?filter=this_year' !!}">This Year</a></li>
                                   <li><a class="dropdown-item" href="{!! route('vendor.order.list', $statusKey).'?filter=previous_year' !!}">Previous Year</a></li>
                                   <li><a class="dropdown-item" href="{!! route('vendor.order.list', $statusKey).'?filter=today' !!}">Today</a></li>
                                </ul>
                            </div>
                            <form action="{{route('vendor.order.list', $statusKey)}}">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="header-title">
                        <h5 class="page-header-title"> {{str_replace('_',' ',$status)}} {{__('messages.orders')}} <span class="badge bg-primary ms-2 py-1">{{$orders->count()}}</span></h5>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        id="datatable-export" data-toggle="data-table-export">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="w-100px">{{__('messages.earning')}} </th>
                                    <th class="w-100px">{{__('messages.collection')}} </th>
                            ...
                            <tbody id="set-rows">
                                ...
                                <tr class="status-{{$order['order_status']}} class-all">
                                    ...
                                    @php
                                        $orderCalculationData = json_decode($order->orderCalculationStmt?->restaurantData)??null ;
                                    @endphp
                                    <td>
                                        <div class="text-right mw-85px">
                                            ...
                                            <div>
                                                {{\App\CentralLogics\Helpers::format_currency($orderCalculationData->earning??0)}}
                                            </div>
                                    ...
                                    <td>
                                        <div class="text-right mw-85px">
                                            {{\App\CentralLogics\Helpers::format_currency($orderCalculationData->receivableAmount??0)}}
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="text-warning mx-2" href="{{route('vendor.order.details',['id'=>$order['id']])}}"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="text-center">
                        <img src="{{asset('assets/images/icons/nodata.png')}}" alt="public" class="w-100">
                    </div>
                    @endif
                    <!-- End Table -->
                </div>
