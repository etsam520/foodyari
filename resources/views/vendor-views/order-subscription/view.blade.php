                ...
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                        ...
                        <span class="ml-2 ml-sm-3">
                            ...
                            </i> {{translate('messages.subscription_period')}} : <strong>{{date('d F Y' ,strtotime($subscription->start_at))}} - {{date('d F Y', strtotime($subscription->end_at))}}</strong>
                        </span>
        ...
        <div class="page-header mb-3 border-bottom">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{$tab=='delivery-log'?'active':''}}" href="{{route('vendor.order.subscription.show', ['subscription'=>$subscription->id])}}?tab=delivery-log"  aria-disabled="true">{{translate('messages.delivery_log')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{$tab=='pause-log'?'active':''}}" href="{{route('vendor.order.subscription.show', ['subscription'=>$subscription->id])}}?tab=pause-log"  aria-disabled="true">{{translate('messages.pause_log')}}</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center" href="javascript:">
                                ...
                                <div class="media-body">
                                    <a class="text-body text-capitalize" href="javascript:void(0)">{{$subscription->customer['f_name'].' '.$subscription->customer['l_name']}}</a>
                                </div>
