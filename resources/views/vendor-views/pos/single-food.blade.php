        ...
        <div class="col-12">
            <div class="bg-white rounded-3 p-3">
                <div class="member-plan d-flex justify-content-between mb-2">
                    ...
                    <div class="d-flex">
                        <div class="me-3">{{ App\CentralLogics\Helpers::format_currency($value->optionPrice) }}</div>
...
<div class="modal-footer border-0 justify-content-between">
    @php($currentPrice = floor(App\CentralLogics\Helpers::food_discount($food->price, $food->discount, $food->discount_type)))
    <?php
    $cartedPrice = null;
    if($cartedItem){
        $cartedPrice = ($currentPrice * $cartedItem['quantity']) + $cartedItem['addon_price'] + $cartedItem['variation_price'] ;
    }
    ?>
    <h6 class="fw-bolder" data-current-price="{{ $currentPrice }}">{{ App\CentralLogics\Helpers::format_currency($cartedPrice??$currentPrice) }}</h6>
