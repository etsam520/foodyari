                   ...
                   <div class="table-responsive">
                      <table id="datatable" class="table" role="grid" data-toggle="data-table">
                         ...
                         <tbody>
                            ...
                            {{-- @dd($employee)  --}}
                            <tr>
                               <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset("admin/$employee->image")}}" alt="profile"></td>
                               ...
                               <td>
                                  <div class="flex align-items-center list-user-action">
                                     ...
                                     <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="{{route('vendor.employee.edit', ['id' => $employee->id])}}">
