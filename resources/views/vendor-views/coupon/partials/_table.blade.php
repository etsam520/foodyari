    ...
    @foreach($coupons as $key=>$coupon)
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-sm btn-white" href="javascript:" onclick="form_alert('coupon-{{$coupon['id']}}','{{ __('Want to delete this coupon ?') }}')" title="{{__('messages.delete')}} {{__('messages.coupon')}}"><i class="tio-delete-outlined"></i>
                </a>
