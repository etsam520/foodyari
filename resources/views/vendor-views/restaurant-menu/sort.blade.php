          ...
          <div class="card">
            <div class="card-header">
                ...
                <div class="header-title d-flex justify-content-between">
                   <h5 class="page-header-title mb-0">Restaurant Menu Sort</h5>
            ...
            <div class="card-body">
                <ul class="list-group" id="sortable">
                    ...
                    <li class="list-group-item border-0 {{ $index % 2 == 0 ? 'bg-light' : '' }}" data-id="{{$list->id}}">
                        <a href="javascript:();">
                        <div class="d-flex align-items-center">
                            <span class="me-3">{{ $index + 1 }}.</span>
                            <img class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded"
                             src="{{$list->image?asset('Category/'.$list->image): asset('assets/images/icons/food-default-image.png')}}" alt="{{Str::ucfirst($list->name)}}" >
...
<script>
    ...
    new Sortable(document.querySelector('#sortable'), {
        ...
        onUpdate: function(eve) {
            ...
            fetch('{{route('vendor.restaurant-menu.sort')}}', {
                method: 'POST',
                headers: {
