...
<head>
    ...
    <title>Food Yari| Owner Dashboard </title>
...
<body class="  ">
    ...
    @include('vendor-owner-views.layouts.dashboard-aside')
    <main class="main-content">
        @include('vendor-owner-views.layouts.dashboard-nav')
        
        @yield('content')

        <!-- Footer Section Start -->
        @include('vendor-owner-views.layouts.dashboard-footer')
        <!-- Footer Section End -->
    </main>
