<div class="position-relative iq-banner">
    ...
    <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
            <a href="{{route('vendorOwner.dashboard')}}" class="navbar-brand">
                <div class="logo-main">
                    ...
                    <li class="nav-item dropdown">
                        <a class="py-0 nav-link d-flex align-items-center" href="javascript:void(0)" id="navbarDropdown"
                            ...
                            <div class="caption ms-3 d-none d-md-block ">
                                <h6 class="mb-0 caption-title">@php($owner = auth('vendor')->user()) {{Str::ucfirst($owner->f_name)}} {{Str::ucfirst($owner->l_name)}}</h6>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{route('vendorOwner.auth.logout')}}">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
