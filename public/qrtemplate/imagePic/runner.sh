...
qrencode -o - -s 30 -l H "$2" | ffmpeg -y \
    -i "$3/logo.png" \
    -i "$3/template.jpg" \
    -f image2pipe -vcodec png -i - \
    -i "$3/restaurant.png" \
...
[tmp_group]drawtext=text='$1':x=225:y=(h-text_h)/2:fontsize=110:fontcolor=#ffa144:fontfile=$3/font/Macondo-Regular.ttf:shadowx=2:shadowy=2:shadowcolor=black[group]; \
