...
// if ($.fn.DataTable) {
//     if ($('[data-toggle="data-table-export"]').length) {
//         const table = $('[data-toggle="data-table-export"]').DataTable({
//             dom: '<"row align-items-center"<"col-md-6" l><"col-md-6" f>><"table-responsive border-bottom my-3" rt><"row align-items-center"<"col-md-6" i><"col-md-6" p>><"clear">',
...
//             .appendTo('.dataTables_wrapper .col-md-6:eq(0)'); // Adjust placement if necessary
//     }
// }
...
const navItems = sidebar?.querySelectorAll('.nav-item a.nav-link') 
Array.from(navItems || [], (elem) => {
  if (url === elem.href || url.includes(elem.href)) {
    elem.classList.add('active')
  }
})
if (sidebar !== null) {
  const sidebarActiveItem = sidebar.querySelectorAll('.active')
  if (sidebarActiveItem.length > 1){
    sidebarActiveItem[0].classList.remove('active')
  }
  ...
  // scrool to active item


  // const activeItem = sidebar.querySelector('.active')
  // sidebar.scrollTop = activeItem.offsetTop - 300
  // if (activeItem !== null) {
