...
class DeliveryManController extends Controller
{
    ...
    {
        $delivery_men = DeliveryMan::where('restaurant_id', Helpers::get_restaurant_id())->latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        $dm->restaurant_id =  Session::get('restaurant')->id;
        ...
        Session::flash('success', 'Delivery Man Added');
