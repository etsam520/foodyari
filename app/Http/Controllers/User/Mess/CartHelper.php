...
class CartHelper
{
    ...
    public static function storeCart($cart)
    {
        ...
        Cookie::queue('MessCart', json_encode($cart), $minutes);
    }
    ...
    public static function itemOfSameRestaurant($item){
        ...
        foreach($cartItems as $cartItem){
            if($cartItem['mess_id'] != $item['messs_id']){
    ...
    {
       return Cookie::queue(Cookie::forget('MessCart'));
    }

    public static function cartExist()
    {
        return Cookie::has('MessCart');
    }
