...
use App\Http\Controllers\Admin\refund\ProcessTransfer as RefundProcessTransfer;
...
class RefundController extends Controller
{
    ...
    private function approveRefund(Refund $refund, Request $request)
    {
        ...
        $processTransfer = new RefundProcessTransfer($refund, $order, $customer, $admin);
        $processTransfer->handle($request);
