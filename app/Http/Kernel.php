...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'mess' => \App\Http\Middleware\mess::class,
        ...
        'custom.broadcast.auth' => \App\Http\Middleware\MultiGuardBroadcastAuth::class,
        'no-cache' => \App\Http\Middleware\NoCache::class,
        'passkey' => \App\Http\Middleware\ValidatePassKey::class,
    ];
}
